...
var webpackConfig = merge(baseWebpackConfig, {
  ...
  output: {
    ...
    chunkFilename: utils.assetsPath('js/[id].[chunkhash].jss')
  },
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      //hash: true,
      /* preloadFont: (() => env.STATIC_PATH.slice(1, env.STATIC_PATH.length - 1) + '/fonts/icomoon.ttf' )() */
    }),
