...
!function(i,n){var l={srcParameter:{bobbleId:null,dev:"biz"},configData:null},o=null,d=null,r=null,c=null,f=`
  ...
  `;function p(){var e=Array.from(i.body.querySelectorAll("*")),t=0;return e.forEach(e=>{e=n.getComputedStyle(e).zIndex;"auto"!==e&&(t=parseInt(e)>=t?parseInt(e):t)}),t+1<=1?2:t+1}if(i.getElementById("justka-bubble")){for(var e,t=i.getElementById("justka-bubble").getAttribute("src"),a={},s=t.slice(t.indexOf("?")+1).split("&"),g=0;g<s.length;g++)e=s[g].split("="),-1<Array.isArray(e[0],a)&&(a[e[0]]=e[1]);l.srcParameter={...a},console.log("JUSTKA...",l),l.srcParameter.bubbleId&&((t=i.createElement("link")).rel="stylesheet",t.type="text/css",t.href=n.JustkaBubble.cssPath,t.onload=function(){setTimeout(function(){l.configData={provision:"8feed844-c12d-4e83-8ea9-ab4b5d859558",account:"d3f53a60-db70-11e9-8a34-2a2ae2dbcce4",config:{welcomeWord:"哈囉您好! 有需要幫忙的地方,歡迎找我喔!",bgColor:"#89e3e9",bgOpacity:.8,size:"L",useBlur:!0},promotion:{}},console.log("假裝取得中台設定好的資料:",l);var e=p();(o=i.createElement("div")).classList.add("justka-bubble-area"),o.classList.add("hide"),o.setAttribute("style","z-index:"+e),(d=i.createElement("div")).classList.add("justka-bubble-btn"),d.classList.add(l.configData.config.size),d.innerHTML=b;(e=i.createElementNS("http://www.w3.org/2000/svg","svg")).setAttribute("width","100%"),e.setAttribute("height","100%");var t,a=i.createElementNS("http://www.w3.org/2000/svg","ellipse"),s=l.configData.config.bgColor||"transparent";a.setAttribute("fill",s),a.setAttribute("cx","50%"),a.setAttribute("cy","50%"),a.setAttribute("rx","40%"),a.setAttribute("ry","40%"),a.setAttribute("opacity",l.configData.config.bgOpacity),l.configData.config.useBlur&&((t=i.createElementNS("http://www.w3.org/2000/svg","radialGradient")).setAttribute("gradientUnits","userSpaceOnUse"),t.setAttribute("id","radialBlur"),t.setAttribute("cx","50%"),t.setAttribute("cy","50%"),t.setAttribute("r","50%"),t.innerHTML=`
        <stop offset="0.6" style="stop-color:${s}"/>
        <stop offset="0.84" style="stop-color:${s}; stop-opacity:0"/>
      `,a.setAttribute("fill","url(#radialBlur)"),e.appendChild(t),e.appendChild(a)),e.appendChild(a),d.appendChild(e),o.appendChild(d),(c=i.createElement("div")).classList.add("description-box"),c.classList.add("hide"),s=`<div>${l.configData.config.welcomeWord}</div><div class="close-btn" id="descriptionCloseBtn">${f}</div>`,c.innerHTML=s,o.appendChild(c),o.addEventListener("transitionend",function e(t){t.target===o&&(c.classList.remove("hide"),o.removeEventListener("transitionend",e))},!1),i.getElementsByTagName("body")[0].appendChild(o),setTimeout(function(){o.classList.remove("hide")},0),d.addEventListener("click",function(){if(i.getElementById("chatBotIframe"))return!1;var e,t;d.classList.add("loading-iframe"),(r=i.createElement("div")).classList.add("justka-iframe-box"),e=p(),r.setAttribute("style","z-index:"+e),e=n.JustkaBubble.imDomain+"/?provision="+l.configData.provision+"&q="+l.configData.provision+"&a="+l.configData.account,(t=i.createElement("iframe")).setAttribute("id","chatBotIframe"),t.setAttribute("src",e),r.innerHTML=`<div class="close-iframe-btn" id="closeIframeBtn">${f}</div>`,r.appendChild(t),i.getElementsByTagName("body")[0].appendChild(r),t.addEventListener("load",function(){i.getElementById("descriptionCloseBtn").click(),d.classList.add("hide")},!1),i.getElementById("closeIframeBtn").addEventListener("click",function(e){d.classList.remove("loading-iframe"),r.classList.remove("iframeIn")},!1),r.addEventListener("transitionend",function(e){var t,a=!1;for(t of e.target.classList)"iframeIn"===t&&(a=!0);a||(d.classList.remove("hide"),r.remove())},!1)},!1),d.addEventListener("transitionend",function(e){var t,a=!0;for(t of e.target.classList)"hide"===t&&(a=!1);a||r.classList.add("iframeIn")},!1),i.getElementById("descriptionCloseBtn").addEventListener("click",function(e){e.target.parentNode.classList.add("hide")},!1)},1e3)},i.getElementsByTagName("head")[0].appendChild(t))}}(document,window);